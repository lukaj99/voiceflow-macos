...
public struct CredentialStatus {
    ...
    public init(isConfigured: Bool, validationStatus: CredentialManager.ValidationStatus, healthStatus: CredentialManager.HealthStatus, lastValidationTime: Date?, lastHealthCheckTime: Date?) {
